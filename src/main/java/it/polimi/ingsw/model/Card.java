...
/**
 * Card class is a enumeration containing the god list and parses the input for them. It also
 * contains an array of gods which are chosen by the challenger in the first phase of the game.
 *
...
public enum Card {
   ...
   * @return Card - the value of the enum choice if exists, otherwise throws an
  ...
  /**
   * Method godsDescription parses all gods' description from JSON file and return the selected
   * god's description.
   *

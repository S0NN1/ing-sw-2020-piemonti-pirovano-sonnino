...
public class MainGuiController implements GUIController {
  ...
  public void apolloDoubleMove(int oldRow1, int oldCol1, int oldRow2, int oldCol2) {
    ...
    worker1.deselect();
    worker1.setFill(new ImagePattern(new Image("/graphics/icons/hammer_"+ board.getColor(oldRow1, oldCol1) + ".png")));
    Worker worker2 = getWorkerFromGrid(oldRow2, oldCol2);
    worker2.setFill(new ImagePattern(new Image("/graphics/icons/hammer_"+ board.getColor(oldRow1, oldCol1) + ".png")));
  }
  ...
  public void minotaurDoubleMove(
    ...
    worker1.setFill(new ImagePattern(new Image("/graphics/icons/hammer_"+ board.getColor(oldRow2, oldCol2) + ".png")));

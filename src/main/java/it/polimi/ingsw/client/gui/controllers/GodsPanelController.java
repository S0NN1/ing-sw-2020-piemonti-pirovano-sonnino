...
public class GodsPanelController implements GUIController {
  ...
  /**
   * Method chooseInit initializes the god panel for user's choosing action. It creates the buttons
   * "Choose" and "Close" and prepares the command "CHOOSE &lt;god-name&gt;" to be sent to the
   * server.
   *

...
/**
 * Class DuplicateNicknameException is thrown when a user tries to connect with a nickname which is
 * already registered (and currently active) on the server process.
 *

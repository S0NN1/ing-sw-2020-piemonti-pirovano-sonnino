...
public class Constants {
  ...
  private static final List<String> BUILD_PHASE_GODS =
      Arrays.asList(DEMETER, HEPHAESTUS, PROMETHEUS, ARTEMIS, HESTIA, TRITON);
  ...
  private static final List<String> MOVE_TO_CELL_OCCUPIED_GODS =
      Arrays.asList(APOLLO, MINOTAUR, CHARON);

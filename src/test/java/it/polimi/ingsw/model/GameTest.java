...
class GameTest {
  ...
  /**
   * Method setupCreatRemoveNextPlayer tests the behaviour in front of player clockwise rotation,
   * and player removal.
   */
  @Test
  ...
  void setupCreateRemoveNextPlayer() {
    ...
    testGame
        .getGameBoard()
        .getSpace(0, 1)
        .setWorker(testGame.getCurrentPlayer().getWorkers().get(0));
    testGame
        .getGameBoard()
        .getSpace(1, 1)
        .setWorker(testGame.getCurrentPlayer().getWorkers().get(1));
    testGame.nextPlayer();

...
class DeckTest {
  ...
  /**
   * Method Initialization creates a new Game, a Deck and 2 test players, with the god powers of
   * Atlas and Athena. The current player is then set as "Luca".
   *
  ...
  /**
   * Method insertWithDuplicate tests deck with a duplicate card insertion. A false return (value 0)
   * is expected.
   *
   * @throws OutOfBoundException when card is invalid.
   */
  ...
  /**
   * Method insertOutOfBound tests deck with an extra-player card insertion (number of god cards
   * &gt; number of players). An "OutOfBoundException" is expected when trying to insert another
   * card.
   */
  @Test
  ...
  /**
   * Method removeCardNotChosenTest tests choice procedure test with a selection of a card which was
   * not chosen by the challenger. A false return of the choose function is expected.
   */
  @Test

...
class HephaestusTest {
   ...
   * two build actions in a single turn.
   */
  @Test
   ...
   * two build actions in a single turn; if the second build is correct: build on the previous
   * space.
   */
  @Test
   ...
   * build actions in a single turn; if the second build is wrong: try to build on different spaces
   */
  @Test

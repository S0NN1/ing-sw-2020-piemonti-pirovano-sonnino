...
public class TritonTest {
  ...
  /**
   * Method init initializes worker with a Triton instance, a new gameBoard and Triton's starting
   * position.
   */
  @BeforeEach
  void init() {
  ...
  /**
   * Method movePerimeterTest tests god's power: it can move another time each time it moves into a
   * perimeter space.
   */
  @Test

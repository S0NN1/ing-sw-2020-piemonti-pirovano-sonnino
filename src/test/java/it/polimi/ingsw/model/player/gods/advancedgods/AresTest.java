...
public class AresTest {
  ...
  /**
   * Method init creates new instances of Ares workers, a virtualClientStub, a gameBoard. Sets ares1
   * position and all the towers from the gameBoard to level 1.
   *
  ...
  void notifyWithRemovableTest() {
    ...
    assertThrows(
        ...
        () -> ares1.notifyWithRemovable(gameBoard, wrongSpace),
        "1");
    assertThrows(
        IllegalStateException.class, () -> ares1.notifyWithRemovable(gameBoard, unmoved), "2");
